...
# you should change this according to your configuration
#To get more information about the parameters, please visit: http://slepc.upv.es
time mpirun -n $NUMPROCS -iface eth0 -f ~/hostfile python3 shell_matrix_example_phi2.py -eps_nev 5 -log_view -eps_view  -eps_max_it 100 -eps_tol 1e-14 -eps_ncv 11 -eps_monitor_all
